...
import PaymentSearch from './../pages/payment.search.page'
        ...
        <Router>
            ...
            >
                <Switch>
                    ...
                    <Route exact path={["/payment/search"]} component={PaymentSearch} />
                    {/* <Route exact path={["/payment/receipt"]} component={PrintPage} /> */}
                </Switch>
            </Layout.Content>
        </Router>
    )
